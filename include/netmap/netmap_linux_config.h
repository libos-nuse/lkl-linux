  	...
  	#define NETMAP_LINUX_CONFIG_H
		...
		#define NETMAP_LINUX_IXGBEVF_HAVE_NTA 

		#define NETMAP_LINUX_IXGBEVF_PTR_ARRAY 

		#define NETMAP_LINUX_IXGBE_HAVE_NTA 
		...
		#define NETMAP_LINUX_HAVE_REFCOUNT_T 

		#define NETMAP_LINUX_HAVE_WAIT_QUEUE_ENTRY_T 

		#define NETMAP_LINUX_HAVE_SCHED_MM 
